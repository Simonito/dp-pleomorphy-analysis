...
GEOJSON_PATH = './data/slide-2024-04-03T07-52-35-R1-S2.geojson'
...
INPUT_WSI_PATH = './data/slide-2024-04-03T07-52-35-R1-S2.mrxs'
...
INFERENCE_INPUT_DATA_DIR = os.path.join(OUT_DIR, 'inference-inputs')
